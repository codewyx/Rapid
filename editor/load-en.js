...
var demoWorkspace = Blockly.inject('blocklyDiv', {toolbox: document.getElementById('toolbox'),grid: {spacing: 40,length: 3,colour: '#ccc',snap: true},});Blockly.Xml.domToWorkspace(document.getElementById('startBlocks'), demoWorkspace);
  ...
  mdui.snackbar({
    message: "Rapid: Code generated successfully, copied!",
    position: "right-top"
  });
}
function saveHtml() {
  ...
  mdui.snackbar({
    message: "Rapid: The Html file downloaded successfully",
    position: "right-top"
  });
}
function about() {
...
function saveblockly() {
  ...
  mdui.snackbar({
    message: "Rapid: Saved successfully",
    position: "right-top"
  });
}
...
var result = base.encode(str);  
  ...
  mdui.snackbar({
    message: "Rapid:Download succeeded",
    position: "right-top"
  });
}
...
function openFile() {
  ...
  reader.onload = function (e) {
    ...
    Blockly.Xml.domToWorkspace(xml, Blockly.getMainWorkspace());
    mdui.snackbar({
      message: "Rapid:Open successfully",
      position: "right-top"
    });
  };
...
window.onbeforeunload = function(event){
	    mdui.snackbar({
      message: "Rapid:Did you save it? Do you really want to close it?",
      position: "right-top"
    });
	return 'Save it!'; 
};
